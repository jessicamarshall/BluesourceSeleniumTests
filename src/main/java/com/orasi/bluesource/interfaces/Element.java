...
import com.orasi.bluesource.interfaces.impl.ElementImpl;
...
public interface Element extends WebElement, WrapsElement, Locatable {
    ...
    /**
     * @author Justin     
     * @see org.orasi.chameleon.interfaces.impl.ElementImpl#clear()
     */
    void clear();
     ...
     * @see org.orasi.chameleon.interfaces.impl.ElementImpl#sendKeys(java.lang.CharSequence...)
     */
     ...
     * @see org.orasi.chameleon.interfaces.impl.ElementImpl#findElement()
     */
     ...
     * @return {@link List} 
     * @see org.orasi.chameleon.interfaces.impl.ElementImpl#findElements()
     */
     ...
     * @see org.orasi.chameleon.interfaces.impl.ElementImpl#getAttribute()
     */    
     ...
     * @see org.orasi.chameleon.interfaces.impl.ElementImpl#getCssValue()
     */
  ...
  Coordinates getCoordinates();
    ...
    * @see org.orasi.chameleon.interfaces.impl.ElementImpl#getLocation()
    */
   Point getLocation();
    ...
    * @see org.orasi.chameleon.interfaces.impl.ElementImpl#getSize()
    */
   Dimension getSize();
    ...
    * @see org.orasi.chameleon.interfaces.impl.ElementImpl#getText()
    */
   String getText();
    ...
    * @see org.orasi.chameleon.interfaces.impl.ElementImpl#getTagName()
    */
   String getTagName();
    ...
    * @see org.orasi.chameleon.interfaces.impl.ElementImpl#isEnabled()
    */
   boolean isEnabled();
    ...
    * @see org.orasi.chameleon.interfaces.impl.ElementImpl#isDisplayed()
    */
   boolean isDisplayed();
     ...
     */
    void syncPresent(WebDriver driver);
     ...
     * @param driver Main WebDriver
     */
    void syncPresent(WebDriver driver, int timeout);
     ...
     * @param driver Main WebDriver
     */
    void syncPresent(WebDriver driver, int timeout, boolean returnError);
     ...
     * @param driver Main WebDriver
     */
    void syncVisible(WebDriver driver);
     ...
     */
    void syncVisible(WebDriver driver, int timeout);
     ...
     */
    void syncVisible(WebDriver driver, int timeout, boolean returnError);
     ...
     * @param driver Main WebDriver
     */
    void syncHidden(WebDriver driver);
     ...
     */
    void syncHidden(WebDriver driver, int timeout);
     ...
     * @param returnError true to throw and error if object is not visible on screen, false if error is not to be thrown
     */
    void syncHidden(WebDriver driver,int timeout, boolean returnError);
     ...
     * @param driver Main WebDriver
     */
    void syncEnabled(WebDriver driver);
     ...
     * @param Will loop for the amount of seconds passed in the variable TIMEOUT
     */
    void syncEnabled(WebDriver driver, int timeout);
     ...
     * @param returnError true to throw and error if object is not visible on screen, false if error is not to be thrown
     */
    void syncEnabled(WebDriver driver, int timeout, boolean returnError);
     ...
     * @param driver Main WebDriver
     */
    void syncDisabled(WebDriver driver);
     ...
     * @param returnError true to throw an error if object is not visible on screen, false if error is not to be thrown
     */
    void syncDisabled(WebDriver driver, int timeout);
     ...
     * @param returnError true to throw and error if object is not visible on screen, false if error is not to be thrown
     */
    void syncDisabled(WebDriver driver,int timeout, boolean returnError);
